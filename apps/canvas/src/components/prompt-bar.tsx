      ...
      >
        {isGenerating ? (
          ...
          <>
            ...
            {imageCount > 0 && (
              <div
                className="flex items-center gap-1 mr-2 px-2 py-1 rounded-lg bg-blue-500/10 text-blue-600 shrink-0"
                title={`${imageCount} reference image${imageCount !== 1 ? "s" : ""} will be included`}
              >
                <svg
                  className="w-3.5 h-3.5"
                  viewBox="0 0 24 24"
